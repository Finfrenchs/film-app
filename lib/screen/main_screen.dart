                          ...
                          child: Column(
                            ...
                            children: [
                              SvgPicture.asset(
                                ...
                                color: _selectedIndex == 0 ? kIconPrimaryColor : kIconSecondaryColor,
                              ),
                              SizedBox(height: 5,),
                              Text(
                                'Home',
                        ...
                        child: Column(
                          ...
                          children: [
                            SvgPicture.asset(
                              ...
                              color: _selectedIndex == 1 ? kIconPrimaryColor : kIconSecondaryColor,
                            ),
                            SizedBox(height: 5,),
                            Text(
                              'Exploration',
                        ...
                        child: Column(
                          ...
                          children: [
                            Icon(
                              ...
                              color: _selectedIndex == 2 ? kIconPrimaryColor : kIconSecondaryColor,
                            ),
                            SizedBox(height: 5,),
                            Text(
                              'Watchlist',
                        ...
                        child: Column(
                          ...
                          children: [
                            SvgPicture.asset(
                              ...
                              color: _selectedIndex == 3 ? kIconPrimaryColor : kIconSecondaryColor,
                            ),
                            SizedBox(height: 5,),
                            Text(
                              'Akun',
